...
function comment_form( $args = array(), $post_id = null ) {
	...
	$defaults = array(
		...
		'comment_notes_after'  => '<p class="form-allowed-tags">' . sprintf( __( 'You may use these <abbr title="HyperText Markup Language">HTML</abbr> tags and attributes: %s' ), ' <code>' . ( function_exists( 'cc_allowed_tags' ) ? cc_allowed_tags() : allowed_tags() ) . '</code>' ) . '</p>',
		'id_form'              => 'commentform',
		'id_submit'            => 'submit',
