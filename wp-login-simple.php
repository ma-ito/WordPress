...
?>
<form name="resetpassform" id="resetpassform" action="<?php echo esc_url( site_url( 'wp-login-simple.php?action=resetpass', 'login_post' ) ); ?>" method="post" autocomplete="off">
